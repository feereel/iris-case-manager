...
from iris_pusher.dfir_iris_client.helper.errors import ApiRequestFailure, InvalidApiResponse, OperationSuccess, IrisStatus, \
    OperationFailure, \
    InvalidObjectMapping, BaseOperationSuccess, IrisClientException
from functools import reduce
from iris_pusher.dfir_iris_client.helper.objects_def import objects_map
...
def get_iris_session():
    ...
    """
    from iris_pusher.dfir_iris_client.session import client_session
    if client_session:
