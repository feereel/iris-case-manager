...
from iris_pusher.dfir_iris_client.helper.case_classifications import CaseClassificationsHelper
from iris_pusher.dfir_iris_client.helper.outcome_status import CaseOutcomeStatusHelper
from iris_pusher.dfir_iris_client.session import ClientSession

from iris_pusher.dfir_iris_client.customer import Customer
from iris_pusher.dfir_iris_client.admin import AdminHelper
from iris_pusher.dfir_iris_client.helper.assets_type import AssetTypeHelper
from iris_pusher.dfir_iris_client.helper.analysis_status import AnalysisStatusHelper
from iris_pusher.dfir_iris_client.helper.compromise_status import CompromiseStatusHelper
...
from iris_pusher.dfir_iris_client.helper.events_categories import EventCategoryHelper
from iris_pusher.dfir_iris_client.helper.task_status import TaskStatusHelper
from iris_pusher.dfir_iris_client.users import User
from iris_pusher.dfir_iris_client.helper.tlps import TlpHelper
from iris_pusher.dfir_iris_client.helper.utils import ClientApiError, ApiResponse, get_data_from_resp
...
class Case(object):
    ...
    def _list_object_comment(self, object_name: str, object_id: int, cid: int = None):
        ...
        return self._s.pi_get(f'case/{object_name}/{object_id}/comments/list', cid=cid)
    ...
    def add_event_comment(self, event_id: int, comment: str, cid: int = None) -> ApiResponse:
        ...
        """
        return self._add_object_comment('timeline/events', event_id, comment, cid=cid)
    ...
    def list_event_comments(self, event_id: int, cid: int = None) -> ApiResponse:
        ...
        """
        return self._list_object_comment('timeline/events', event_id, cid=cid)
    ...
    def delete_event_comment(self, event_id: int, comment_id: int, cid: int = None) -> ApiResponse:
        ...
        """
        return self._delete_object_comment('timeline/events', event_id, comment_id, cid=cid)
    ...
    def update_event_comment(self, event_id: int, comment_id: int, comment: str, cid: int = None) -> ApiResponse:
        ...
        """
        return self._update_object_comment('timeline/events', event_id, comment_id, comment, cid=cid)
